...
public class RecordUtils {
	...
	public static String getJoinNetTime(IDataRecord rec) {
		Object joinNetTime = rec.get(rec.getAttrIdxByName(ColumnConstants.COL_JOIN_NET_TIME));
		return joinNetTime.toString();
	}
	
	public static boolean isGroupUser(IDataRecord rec) {
		Object isGroupUserObj = rec.get(rec.getAttrIdxByName(ColumnConstants.COL_IS_GROUP_CUSTOMER));
	...
	public static String getContractFrom(IDataRecord rec) {
		Object contractFrom = rec.get(rec.getAttrIdxByName(ColumnConstants.COL_CONTRACT_FROM));
	...
	public static String getContractTo(IDataRecord rec) {
		Object contractTo = rec.get(rec.getAttrIdxByName(ColumnConstants.COL_CONTRACT_TO));
		if(contractTo == null)
			return null;
	...
	public static String getPhoneNo(IDataRecord rec) {
		Object phoneNo = rec.get(rec.getAttrIdxByName(ColumnConstants.COL_PHONE_NO));
		return phoneNo.toString();
	}
	
	public static boolean is3GUser(IDataRecord rec) {
		int networkIdx = (int)rec.getAttrIdxByName(ColumnConstants.COL_NETWORK);
	...
	public static int getYearMonth(IDataRecord rec) {
		int yearMonthIdx = (int) rec.getAttrIdxByName(ColumnConstants.COL_YEAR_MONTH);
	...
	public static int getIncome(IDataRecord rec) {
		if(rec == null)
			return 0;
		int incomeIdx = (int)rec.getAttrIdxByName(ColumnConstants.COL_INCOME);
	...
	public static int getCallNumber(IDataRecord rec) {
		if(rec == null)
			return 0;
		int callNumIdx = (int)rec.getAttrIdxByName(ColumnConstants.COL_CALL_NUMBER);
	...
	public static int getSms(IDataRecord rec) {
		if(rec == null)
			return 0;
		int smsIdx =(int)rec.getAttrIdxByName(ColumnConstants.COL_SMS);
	...
	public static int getGprs(IDataRecord rec) {
		if(rec == null)
			return 0;
		int gprsIdx = (int)rec.getAttrIdxByName(ColumnConstants.COL_GPRS);

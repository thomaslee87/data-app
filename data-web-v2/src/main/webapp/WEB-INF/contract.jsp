...
<head>
    ...
    <link href='css/intellbi.biz.css'  rel='stylesheet'/>
	...
	<style>
		...
		table.intellbi thead th {
		    text-align: center;
		    background: #66a9bd;
		}
		 
		table.intellbi tbody td {
		    text-align: center;
		    background: #d5eaf0;
		}
	</style>
...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="my"> <!--img alt="Charisma Logo" src="img/logo20.png" class="hidden-xs"/-->
...
<div class="ch-container">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="my"><i class="glyphicon glyphicon-home"></i><span> 我的工作台</span></a>
                        </li>
                        <li><a class="ajax-link" href="showContract"><i class="glyphicon glyphicon-list-alt"></i><span> 保有任务</span></a>
                        </li>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 用户保有任务</h2>
    ...
    <table class="table table-striped bootstrap-datatable datatable responsive intellbi"><!-- table-bordered  -->
    <thead>
    <tr>
    	<th>手机号</th>
        <th>优先级</th>
    ...
    <tbody>
    	...
    	<tr>
			...
			<td class="center">
            	<span class="label-success label label-default">已处理</span>
            	<span class="label-danger label label-default">待处理</span>
			</td>

			<td class="center">
				<a href="#" class="btn btn-info btn-xs" data-toggle="popover-left"
                               data-content='预计平均每月可节省 <s:property value="recommendCost1"/>元'
                               title='<span class="label label-warning">荐</span> <s:property value="recommend1"/>'>

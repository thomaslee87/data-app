...
<body>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <!--   <li>
                        ...
                        <li>
                            <a class="active" href="contract.html"><i class="fa fa-refresh fa-fw"></i> 续约任务</a>
                        </li>
                        <li>
                    ...
                    <div id="J-main-panel" class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped  table-hover"" id="J-table-contract">
                                    <thead>
                                        <tr class="success">
                                            <th>手机号</th>
                                            <!--th>优先级</th-->
    ...
    <script src="js/biz.contract.js"></script>

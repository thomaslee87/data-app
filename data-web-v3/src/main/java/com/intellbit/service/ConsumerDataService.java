...
public interface ConsumerDataService {
	...
	public int getContractConsumersCount(int userId, String theMonth, RequestQueryFilter filter);
	public List<ConsumerBillDO> getContractConsumers(int userId, String theMonth, int pageStart, int pageSize, List<String> orderFields, RequestQueryFilter filter);

                ...
                <div class="col-lg-12">
                    <h1 class="page-header">续约任务
                    	<div style="display:inline" id="taskView">
		                    <label class="radio-inline" style="font-size:14px"><input type="radio" checked name="inlineRadioOptions" id="rDay" value="day" style="margin-top:1px"> 日视图</label>
							...
							<label class="radio-inline" style="font-size:14px"><input type="radio" name="inlineRadioOptions" id="rMonth" value="month" style="margin-top:1px"> 月视图</label>
						</div>

...
<body>
													...
													<s:else>
														<li class="list-group-item"><span
															...
															<button type="button" class="btn btn-danger btn-xs"
																...
																data-content='<s:property value="rcmd1pkg"/>' title=""
																data-original-title="<center><span class=&quot;label label-warning&quot;>
																套餐资费</span>
																</center>
																">
																<s:property value="recommend1" />
															</button> 预计平均每月消费<s:property value="recommendCost1" />元， 平均每月可节省<s:property
																value="recommendSave1" />元</li>
														<s:if test="recommend2 != '' && recommendSave2 > 0">
															<li class="list-group-item"><span
																class="label label-warning">荐</span>
																<button type="button" class="btn btn-danger btn-xs"
																	data-toggle="popover-left"
																	data-content='<s:property value="rcmd2pkg"/>' title=""
																	data-original-title="<center><span class=&quot;label label-warning&quot;>
																	套餐资费</span>
																	</center>
																	">
																	<s:property value="recommend2" />
																</button> 预计平均每月消费<s:property value="recommendCost2" />元，
														...
														<s:if test="recommend3 != '' && recommendSave3 > 0">
															<li class="list-group-item"><span
																...
																<button type="button" class="btn btn-danger btn-xs"
																	data-toggle="popover-left"
																	data-content='<s:property value="rcmd3pkg"/>' title=""
																	data-original-title="<center><span class=&quot;label label-warning&quot;>
																	套餐资费</span>
																	</center>
																	">
																	<s:property value="recommend3" />
																</button> 预计平均每月消费<s:property value="recommendCost3" />元，
											...
											<div id="collapseTwo" class="panel-collapse collapse in">
												<ul class="list-group">
													<li class="list-group-item"><span
														...
														<button type="button" class="btn btn-danger btn-xs"
															data-toggle="popover-left"
															data-content='<s:property value="rcmd1pkg4G"/>' title=""
															data-original-title="<center><span class=&quot;label label-warning&quot;>
															4G套餐资费</span>
															</center>
															"> （4G）
															<s:property value="recommend1_4G" />
														</button> 预计平均每月消费<s:property value="recommendCost1_4G" />元， <s:if
													...
													<s:if test="recommend2_4G != '' && recommendSave2_4G > 0">
														<li class="list-group-item"><span
															...
															<button type="button" class="btn btn-danger btn-xs"
																data-toggle="popover-left"
																data-content='<s:property value="rcmd2pkg4G"/>' title=""
																data-original-title="<center><span class=&quot;label label-warning&quot;>
																4G套餐资费</span>
																</center>
																"> （4G）
																<s:property value="recommend2_4G" />
															</button> 预计平均每月消费<s:property value="recommendCost2_4G" />元，
													...
													<s:if test="recommend3_4G != '' && recommendSave3_4G > 0">
														<li class="list-group-item"><span
															...
															<button type="button" class="btn btn-danger btn-xs"
																data-toggle="popover-left"
																data-content='<s:property value="rcmd3pkg4G"/>' title=""
																data-original-title="<center><span class=&quot;label label-warning&quot;>
																4G套餐资费</span>
																</center>
																"> （4G）
																<s:property value="recommend3_4G" />
															</button> 预计平均每月消费<s:property value="recommendCost3_4G" />元，
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$.get("getFeedback", 
					{ 
						theMonth: "<s:property value='theBizMonth' />",
						phone: "<s:property value='phoneNo' />",
						type: 0,
					},
					function(data){

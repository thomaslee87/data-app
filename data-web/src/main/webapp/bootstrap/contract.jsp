...
<div class="ch-container">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="index.html"><i class="glyphicon glyphicon-home"></i><span> 我的工作台</span></a>
                        </li>
                        <li><a class="ajax-link" href="contract.html"><i class="glyphicon glyphicon-list-alt"></i><span> 保有任务</span></a>
                        </li>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 消费数据</h2>

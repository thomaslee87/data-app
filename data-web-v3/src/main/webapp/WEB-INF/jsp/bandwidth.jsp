...
<body>
                       ...
                       <!--   <li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level collapse in">
                                <li>
                                    <a class="active" href="bandwidth.html">4G带宽升级</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <div id="J-main-panel" class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="J-table-bandwidth">
                                    <thead>
									    <tr class="success">
									    	<th>手机号</th>
									        <!--th>优先级</th-->
    ...
    <script src="js/biz.bandwidth.js"></script>

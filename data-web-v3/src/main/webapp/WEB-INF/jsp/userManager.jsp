                                ...
                                <table class="table table-striped table-bordered table-hover" id="dt-users">
                                    <thead>
									    ...
									    <c:forEach var="user" items="${users}" varStatus="vs">
											...
											<td>
												<fmt:formatDate value="${user.gmtCreate}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>
											</td>
											<td>
												<fmt:formatDate value="${user.gmtModified}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>
											</td>
											<td>
												<fmt:formatDate value="${user.gmtLogin}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>
											</td>
											<%-- <td><a class="btn"
